...
apache.vm.synced_folder "/Users/joallysson/Music/", "/home/vagrant"
  ...
  apache.vm.provision "puppet" do |puppet|
              puppet.manifests_path = "/Users/joallysson/Music/vagrant/manifests"
...
mysql.vm.hostname = "mysqldb"
 mysql.vm.network "forwarded_port",guest: 3306, host: 3306
    mysql.vm.network "public_network", ip:"192.168.0.55"

  
  #mysql.vm.network "public_network", ip: "192.168.0.55"
mysql.vm.synced_folder ".", "/home/vagrant"
mysql.vm.synced_folder "/Users/joallysson/Music/vagrant/mysql", "/home/vagrant"
...
config.vm.define "ansible" do |ansible|
    ...
    ansible.vm.network "public_network", ip: "192.168.0.55"

    

    ansible.vm.synced_folder ".", "/home/vagrant"
    ansible.vm.synced_folder "/Users/joallysson/Music/vagrant/ansible", "/home/vagrant"
